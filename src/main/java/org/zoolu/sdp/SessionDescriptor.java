...
public class SessionDescriptor {
	...
	public SessionDescriptor(String origin, String session, String connection, String time) {
		init(new OriginField(origin), new SessionNameField(session), new ConnectionField(connection),
				new TimeField(time));
	}
	...
	public SessionDescriptor(String owner, String address) {
		...
		if (owner == null)
			owner = "user@" + address;
		init(new OriginField(owner, "0", "0", address), new SessionNameField("Session SIP/SDP"),
				new ConnectionField("IP4", address), new TimeField());
	}
	 ...
	 * @return this SessionDescriptor
	 */
	public SessionDescriptor addMedia(MediaField media, AttributeField attribute) { // printlog("DEBUG: media:
																					// "+media,5);
																					// printlog("DEBUG: attribute:
																					// "+attribute,5);
	 ...
	 * @return this SessionDescriptor
	 */
	public SessionDescriptor addMedia(MediaField media, Vector<AttributeField> attributes) { // printlog("DEBUG: media:
																								// "+media,5);
																								// printlog("DEBUG:
																								// attribute:
																								// "+attributes,5);
	 ...
	 * @return this SessionDescriptor
	 */
	public SessionDescriptor addMediaDescriptor(MediaDescriptor media_desc) { // printlog("DEBUG: media desc:
																				// "+media_desc,5);
	 ...
	 * @return this SessionDescriptor
	 */
	public SessionDescriptor addMediaDescriptors(Vector<MediaDescriptor> media_descs) { // media.addAll(media_descs); //
																						// not supported by J2ME..
	...
	public boolean hasAttribute(String attribute_name) {
		for (int i = 0; i < av.size(); i++) {
			if (av.elementAt(i).getAttributeName().equals(attribute_name))
				return true;
		}
		return false;
	}
