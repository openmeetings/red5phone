...
class SdpParser extends Parser {
	...
	/**
	 * Returns the SdpField at the current position. The SDP value terminates with
	 * the end of the String or with the first CR or LF char.
	 * <p>
	 ...
	 * (!par.hasMore()) return null; char type=par.getChar(); par.skipChar(); String
	 * value=par.skipChar().getLine(); if (value==null) return null;
	 * index=par.getPos(); // for DEBUG return new SdpField(type,value); }
	 */
	...
	/**
	 * Returns the first SdpField of type <i>type</i>. The SDP value terminates with
	 * the end of the String or with the first CR or LF char.
	 * 
