...
public class MediaDescriptor {
	...
	public MediaDescriptor(MediaDescriptor md) {
		...
		for (int i = 0; i < md.av.size(); i++)
			av.addElement(new AttributeField(md.av.get(i)));
	}

	/**
	 * Creates a new MediaDescriptor with m <i>media</i> and c <i>connection</i>. No
	 * attribute is set by default.
	 * 
	 * @param media
	 *            the MediaField
	 * @param connection
	 *            the ConnectionField, or null if no ConnectionField is present in
	 *            the MediaDescriptor
	 */
	...
	/**
	 * Creates a new MediaDescriptor with m <i>media</i>, c <i>connection</i>, and a
	 * <i>attribute</i>.
	 * 
	 * @param media
	 *            the MediaField
