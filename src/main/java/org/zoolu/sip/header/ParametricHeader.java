...
public abstract class ParametricHeader extends Header {
	 ...
	 * 
	 * @returns the index of the semicolon before the first parameter, or -1 if no
	...
	/**
	 * Sets the value of a specified parameter. Zero-length String is returned in
	 * case of flag parameter (without value).
	 */
