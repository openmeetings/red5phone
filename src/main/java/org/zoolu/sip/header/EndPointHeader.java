...
public abstract class EndPointHeader extends NameAddressHeader {
	 ...
	 * name-address within an EndPointHeader that may have some header parameters.
	 */
	 ...
	 * 
	 * @return the end point NameAddress or null if NameAddress does not exist (that
	 *         leads to the wildcard in case of ContactHeader)
	 */
	public NameAddress getNameAddress() {
		NameAddress naddr = (new SipParser(value)).getNameAddress();
		// patch for removing eventual 'tag' or other EndPointHeader parameters from
		// NameAddress
