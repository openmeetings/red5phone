...
public class DigestAuthentication {
	...
	public AuthorizationHeader getAuthorizationHeader() {
		...
		/*
		 * if (qop!=null) ah.addQopParam(qop); if (nc!=null) ah.addNcParam(nc);
		 */
		...
		if (qop != null) {
			...
			if (qop.equalsIgnoreCase("auth-int") || qop.equalsIgnoreCase("auth")) {
				...
				nc = "00000001"; // always 1 since cnonce should be unique - avoids having to have a static
									// counter
				ah.addNcParam(nc);
			}
		}
	...
	/**
	 * Main method. It tests DigestAuthentication with the example provided in the
	 * RFC2617.
	 */
