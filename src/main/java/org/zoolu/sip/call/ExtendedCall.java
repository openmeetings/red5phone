...
public class ExtendedCall extends Call implements ExtendedInviteDialogListener {
	private static final Logger log = LoggerFactory.getLogger(ExtendedCall.class);
	...
	public void onDlgRefer(org.zoolu.sip.dialog.InviteDialog d, NameAddress refer_to, NameAddress referred_by,
			Message msg) {
		if (d != dialog) {
