...
public abstract class CallListenerAdapter implements ExtendedCallListener {
	...
	/**
	 * Changes the current session descriptor specifing the receiving RTP/UDP port
	 * number, the AVP format, the codec, and the clock rate
	 */
	/*
	 * public static String audioSession(int port, int avp, String codec, int rate)
	 * { SessionDescriptor sdp=new SessionDescriptor(); sdp.addMedia(new
	...
	/**
	 * Accepts an incoming call. Callback function called when arriving a new INVITE
	 * method (incoming call)
	 */
	public void onCallIncoming(Call call, NameAddress callee, NameAddress caller, String sdp, Message invite) { // printLog("INCOMING");
		call.ring();
	 ...
	 */
	public void onCallRedirection(Call call, String reason, Vector<String> contact_list, Message resp) { // printLog("REDIRECTION
																											// ("+reason+")");
	...
	/**
	 * Does nothing. Callback function called when arriving a 2xx (re-invite/modify
	 * accepted)
	 */
	...
	/**
	 * Does nothing. Callback function called when arriving a 4xx (re-invite/modify
	 * failure)
	 */
	...
	/**
	 * Does nothing. Callback function called when a call transfer is successfully
	 * completed
	 */
	 ...
	 */
	public void onCallTransferFailure(ExtendedCall call, String reason, Message notify) { // printLog("TRANSFER
																							// FAILURE");
	}
