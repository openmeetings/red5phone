...
public class SdpTools {
	/**
	 * Costructs a new SessionDescriptor from a given SessionDescriptor with olny
	 * media types and attribute values specified by a MediaDescriptor Vector.
	 * <p>
	 * If no attribute is specified for a particular media, all present attributes
	 * are kept. <br>
	...
	/**
	 * Costructs a new SessionDescriptor from a given SessionDescriptor with olny
	 * the first specified media attribute. /** Keeps only the fisrt attribute of
	 * the specified type for each media.
	 * <p>
