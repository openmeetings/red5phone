...
public interface ExtendedInviteDialogListener extends org.zoolu.sip.dialog.InviteDialogListener {
	...
	public void onDlgRefer(org.zoolu.sip.dialog.InviteDialog dialog, NameAddress refer_to, NameAddress referred_by,
			Message msg);
	...
	// public void onDlgNotifyResponse(org.zoolu.sip.dialog.InviteDialog dialog, int
	// code, String reason, Message msg);
	 ...
	 */
	public void onDlgAltResponse(org.zoolu.sip.dialog.InviteDialog dialog, String method, int code, String reason,
	 ...
	 * CANCEL, ACK, BYE, REFER, NOTIFY
	 */
	// public void onDlgAltTimeout(org.zoolu.sip.dialog.InviteDialog dialog, String
	// method);
}
