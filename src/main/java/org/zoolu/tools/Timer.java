...
public class Timer implements InnerTimerListener {
	...
	void init(long t_msec, String t_label, TimerListener t_listener) { // listener_list=new HashSet();
																		// if (t_listener!=null)
	...
	/**
	 * Creates a new Timer of <i>msec</i> milliseconds. The Timer is not started.
	 * You need to fire the start() method.
	 */
	/*
	...
	/**
	 * Creates a new Timer of <i>msec</i> milliseconds, with a label <i>t_event</i>,
	 * and with TimerListener <i>listener</i> The Timer is not started. You need to
	 * fire the start() method.
	 */
	...
	public void onInnerTimeout() { // if (active && !listener_list.isEmpty())
