...
public class Parser {
	...
	/**
	 * Creates the Parser from the String <i>s</i> and point to the beginning of the
	 * string.
	 */
	...
	/**
	 * Creates the Parser from the StringBuffer <i>sb</i> and point to the beginning
	 * of the string.
	 */
	...
	/**
	 * Creates the Parser from the StringBuffer <i>sb</i> and point to the position
	 * <i>i</i>.
	 */
	...
	/*
	 * private boolean isUpAlpha(int i) { return isUpAlpha(str.charAt(i)); } private
	 * boolean isLowAlpha(int i) { return isLowAlpha(str.charAt(i)); } private
	 * boolean isAlpha(int i) { return isAlpha(str.charAt(i)); } private boolean
	 * isDigit(int i) { return isDigit(str.charAt(i)); } private boolean isChar(int
	 * i) { return isChar(str.charAt(i)); } private boolean isCR(int i) { return
	 * isCR(str.charAt(i)); } private boolean isLF(int i) { return
	...
	/**
	 * Gets the index of the first occurence of any char of array <i>cc</i> within
	 * string <i>str</i> starting form <i>begin</i>; return -1 if no occurence is
	 * found
	 */
	...
	/**
	 * Gets the index of the first occurence of any string of array <i>ss</i> within
	 * string <i>str</i>; return -1 if no occurence is found.
	 */
	...
	/**
	 * Gets all chars until the end of the line (or the end of the parser) and go to
	 * the next line.
	 */
