...
public class UdpPacket {
	...
	/**
	 * Gets the IP address of the machine to which this datagram is being sent or
	...
	/**
	 * Gets the port number on the remote host to which this datagram is being sent
