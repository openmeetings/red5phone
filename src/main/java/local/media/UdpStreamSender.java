...
public class UdpStreamSender extends Thread {
	 ...
	 *            UdpStreamSender, or it is performed by the InputStream (e.g. the
	 *            system audio input)
	 * @param frame_rate
	 ...
	 */
	public UdpStreamSender(InputStream input_stream, boolean do_sync, long frame_rate, int frame_size, String dest_addr,
			int dest_port) {
	 ...
	 */
	public UdpStreamSender(InputStream input_stream, boolean do_sync, long frame_rate, int frame_size,
			UdpSocket src_socket, String dest_addr, int dest_port) {
		init(input_stream, do_sync, frame_rate, frame_size, src_socket, dest_addr, dest_port);
	}

	/** Inits the UdpStreamSender */
	private void init(InputStream input_stream, boolean do_sync, long frame_rate, int frame_size, UdpSocket src_socket,
