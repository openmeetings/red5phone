...
public class ToneInputStream extends java.io.InputStream {
	...
	/*
	 * public ToneInputStream(int frequence, double ampliture, int sample_rate, int
	 * codec) { init(frequence,ampliture,sample_rate,1,codec); }
	 */

	/** Creates a new ToneInputStream */
	public ToneInputStream(int frequence, double ampliture, int sample_rate, int sample_size, int codec,
			boolean big_endian) {
		init(frequence, ampliture, sample_rate, sample_size, codec, big_endian);
	}

	/** Inits the ToneInputStream */
	private void init(int frequence, double ampliture, int sample_rate, int sample_size, int codec,
			boolean big_endian) {
		this.f0 = frequence;
		this.fs = sample_rate;
